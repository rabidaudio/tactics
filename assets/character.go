...
// 		sprites: map[AnimationState]sprite.Sprite{
// 			StateIdle:   castle.SpriteFromRow(0, 1, 4).Loop().Sprite(),
// 			StateWalk:   castle.SpriteFromRow(4, 1, 4).Loop().Sprite(),
// 			StateAttack: castle.SpriteFromRow(8, 1, 4).Sprite(),
// 			StateHit:    castle.SpriteFromRow(12, 1, 4).Sprite(),
// 			StateDeath:  castle.SpriteFromRow(16, 1, 4).Sprite(),
// 		},
// 		state: StateIdle,
// 	}
// }
...
// func BarbarianSholderReverse() sprite.Sprite {
// 	return tower.SpriteFromRow(4, 1, 4).Reverse()
// }

// func Barbarian() CharacterAnimation {
// 	return CharacterAnimation{
// 		sprites: map[AnimationState]sprite.Sprite{
// 			StateIdle: tower.SpriteFromRow(0, 1, 4).Loop().Sprite(),
// 			StateWalk: tower.SpriteFromRow(20, 1, 4).Concat(
// 				tower.SpriteFromRow(4, 1, 4).Loop().Sprite()).Sprite(),
