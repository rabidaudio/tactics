...
func (g *Game) NewMoveCommand(unit *unit.Unit, dest units.TPoint) MoveCommand {
...
func (cmd MoveCommand) IsLegal(g *Game) bool {
...
func (cmd MoveCommand) Execute(g *Game) {
...
func (cmd AttackCommand) IsLegal(g *Game) bool {
...
func (cmd AttackCommand) Execute(g *Game) {
